...
// gameInit.c
void start(); // 카드게임 시작 - init호출, board호출, play호출
void init(); // 초기설정-52개 카드 생성, 참가자 설정, 파일로드
void board(); // 게임 판 그리기

//blackJackFile.c - 파일명  blackJList.c
void load(); 
void save(); 
//player구조체의 num과 money내용 저장, 불러오기
